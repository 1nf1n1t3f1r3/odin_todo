...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Project)\n/* harmony export */ });\nclass Project {\n  constructor(name) {\n    this.id = crypto.randomUUID();\n    this.name = name;\n    this.todos = [];\n    this.createdAt = new Date();\n  }\n\n  addTodo(todo) {\n    this.todos.push(todo);\n  }\n\n  removeTodo(todoId) {\n    this.todos = this.todos.filter((todo) => todo.id !== todoId);\n  }\n\n  getTodo(todoId) {\n    return this.todos.find((todo) => todo.id === todoId);\n  }\n}\n\n\n//# sourceURL=webpack://odin_restaurant/./src/classes/project.js?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getCurrentProject: () => (/* binding */ getCurrentProject),\n/* harmony export */   getProjects: () => (/* binding */ getProjects),\n/* harmony export */   setCurrentProject: () => (/* binding */ setCurrentProject),\n/* harmony export */   toggleTodo: () => (/* binding */ toggleTodo)\n/* harmony export */ });\n/* harmony import */ var _classes_project_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes/project.js */ \"./src/classes/project.js\");\n\n\nconst defaultProject = new _classes_project_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Default\");\n\nlet projects = [defaultProject];\nlet currentProject = defaultProject;\n\nfunction getProjects() {\n  return projects;\n}\n\nfunction getCurrentProject() {\n  return currentProject;\n}\n\nfunction setCurrentProject(project) {\n  currentProject = project;\n}\n\n// state.js\nfunction toggleTodo(todoId) {\n  const todo = currentProject.getTodo(todoId);\n  if (todo) {\n    todo.toggleComplete();\n  }\n}\n\n\n//# sourceURL=webpack://odin_restaurant/./src/state.js?\n}");
